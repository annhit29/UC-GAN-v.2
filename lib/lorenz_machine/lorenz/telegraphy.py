...
format) to and from the five-bit ITA2 "Baudot" standard: https://en.wikipedia.org/wiki/Baudot_code#:~:text=to%20the%20sender.-,ITA2,-%5Bedit%5D 
"""
# The folks at Bletchley Park used a "shiftless" variant of the ITA2, as it
# allowed for easier cryptanalysis.
BP_SHIFTLESS_ITA2 = list("/T3O9HNM4LRGIPCVEZDBSYFXAWJ+UQK8")  #ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789
#todo recoit A~Z et aussi 0~9 et qq ponctuations, donc l'erreur vient pas du fait d'utiliser Baudot.
#todo: cf machines.py L59 pk restriction [0, 31].
